...
public final class RPCGrpc {
  ...
  public static final String SERVICE_NAME = "proto_java.RPC";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<proto_java.KaspadMessage,
      proto_java.KaspadMessage> getMessageStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MessageStream",
      requestType = proto_java.KaspadMessage.class,
      responseType = proto_java.KaspadMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<proto_java.KaspadMessage,
      proto_java.KaspadMessage> getMessageStreamMethod() {
    io.grpc.MethodDescriptor<proto_java.KaspadMessage, proto_java.KaspadMessage> getMessageStreamMethod;
      ...
      synchronized (RPCGrpc.class) {
        if ((getMessageStreamMethod = RPCGrpc.getMessageStreamMethod) == null) {
          RPCGrpc.getMessageStreamMethod = getMessageStreamMethod =
              io.grpc.MethodDescriptor.<proto_java.KaspadMessage, proto_java.KaspadMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MessageStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto_java.KaspadMessage.getDefaultInstance()))
  ...
  public static abstract class RPCImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<proto_java.KaspadMessage> messageStream(
        io.grpc.stub.StreamObserver<proto_java.KaspadMessage> responseObserver) {
  ...
  private static abstract class RPCBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return proto_java.Messages.getDescriptor();
    }
