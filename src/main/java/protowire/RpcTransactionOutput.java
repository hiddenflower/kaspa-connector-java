...
/**
 * Protobuf type {@code protowire.RpcTransactionOutput}
 */
public final class RpcTransactionOutput extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:protowire.RpcTransactionOutput)
...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            protowire.RpcTransactionOutputVerboseData.Builder subBuilder = null;
            if (verboseData_ != null) {
              subBuilder = verboseData_.toBuilder();
            }
            verboseData_ = input.readMessage(protowire.RpcTransactionOutputVerboseData.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return protowire.Rpc.internal_static_protowire_RpcTransactionOutput_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return protowire.Rpc.internal_static_protowire_RpcTransactionOutput_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            protowire.RpcTransactionOutput.class, protowire.RpcTransactionOutput.Builder.class);
  }
  ...
  private protowire.RpcTransactionOutputVerboseData verboseData_;
  /**
   ...
   */
  @java.lang.Override
  public protowire.RpcTransactionOutputVerboseData getVerboseData() {
    return verboseData_ == null ? protowire.RpcTransactionOutputVerboseData.getDefaultInstance() : verboseData_;
  }
  /**
   * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
   */
  @java.lang.Override
  public protowire.RpcTransactionOutputVerboseDataOrBuilder getVerboseDataOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof protowire.RpcTransactionOutput)) {
      return super.equals(obj);
    }
    protowire.RpcTransactionOutput other = (protowire.RpcTransactionOutput) obj;
  ...
  public static protowire.RpcTransactionOutput parseFrom(
  ...
  public static protowire.RpcTransactionOutput parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static protowire.RpcTransactionOutput parseFrom(
  ...
  public static protowire.RpcTransactionOutput parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static protowire.RpcTransactionOutput parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static protowire.RpcTransactionOutput parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(protowire.RpcTransactionOutput prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:protowire.RpcTransactionOutput)
      protowire.RpcTransactionOutputOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protowire.Rpc.internal_static_protowire_RpcTransactionOutput_descriptor;
    }
    ...
    // Construct using protowire.RpcTransactionOutput.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public protowire.RpcTransactionOutput getDefaultInstanceForType() {
      return protowire.RpcTransactionOutput.getDefaultInstance();
    }

    @java.lang.Override
    public protowire.RpcTransactionOutput build() {
      protowire.RpcTransactionOutput result = buildPartial();
    ...
    @java.lang.Override
    public protowire.RpcTransactionOutput buildPartial() {
      protowire.RpcTransactionOutput result = new protowire.RpcTransactionOutput(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof protowire.RpcTransactionOutput) {
        return mergeFrom((protowire.RpcTransactionOutput)other);
      } else {
    ...
    public Builder mergeFrom(protowire.RpcTransactionOutput other) {
      if (other == protowire.RpcTransactionOutput.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      protowire.RpcTransactionOutput parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (protowire.RpcTransactionOutput) e.getUnfinishedMessage();
    ...
    private protowire.RpcTransactionOutputVerboseData verboseData_;
    private com.google.protobuf.SingleFieldBuilderV3<
        protowire.RpcTransactionOutputVerboseData, protowire.RpcTransactionOutputVerboseData.Builder, protowire.RpcTransactionOutputVerboseDataOrBuilder> verboseDataBuilder_;
    /**
     * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
     * @return Whether the verboseData field is set.
     */
     ...
     * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
     */
    public Builder setVerboseData(protowire.RpcTransactionOutputVerboseData value) {
      if (verboseDataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setVerboseData(
        protowire.RpcTransactionOutputVerboseData.Builder builderForValue) {
      if (verboseDataBuilder_ == null) {
     ...
     * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
     */
    public Builder mergeVerboseData(protowire.RpcTransactionOutputVerboseData value) {
      if (verboseDataBuilder_ == null) {
        if (verboseData_ != null) {
          verboseData_ =
            protowire.RpcTransactionOutputVerboseData.newBuilder(verboseData_).mergeFrom(value).buildPartial();
        } else {
          verboseData_ = value;
        }
        onChanged();
     ...
     * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
     */
    public protowire.RpcTransactionOutputVerboseData.Builder getVerboseDataBuilder() {
    ...
    public protowire.RpcTransactionOutputVerboseDataOrBuilder getVerboseDataOrBuilder() {
      if (verboseDataBuilder_ != null) {
        ...
        return verboseData_ == null ?
            protowire.RpcTransactionOutputVerboseData.getDefaultInstance() : verboseData_;
      }
    }
    /**
     * <code>.protowire.RpcTransactionOutputVerboseData verboseData = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        protowire.RpcTransactionOutputVerboseData, protowire.RpcTransactionOutputVerboseData.Builder, protowire.RpcTransactionOutputVerboseDataOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:protowire.RpcTransactionOutput)
  }

  // @@protoc_insertion_point(class_scope:protowire.RpcTransactionOutput)
  private static final protowire.RpcTransactionOutput DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new protowire.RpcTransactionOutput();
  }

  public static protowire.RpcTransactionOutput getDefaultInstance() {
