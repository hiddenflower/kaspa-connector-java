...
/**
 * Protobuf type {@code protowire.TransactionOutput}
 */
public final class TransactionOutput extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:protowire.TransactionOutput)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return protowire.P2P.internal_static_protowire_TransactionOutput_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return protowire.P2P.internal_static_protowire_TransactionOutput_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            protowire.TransactionOutput.class, protowire.TransactionOutput.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof protowire.TransactionOutput)) {
      return super.equals(obj);
    }
    protowire.TransactionOutput other = (protowire.TransactionOutput) obj;
  ...
  public static protowire.TransactionOutput parseFrom(
  ...
  public static protowire.TransactionOutput parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static protowire.TransactionOutput parseFrom(
  ...
  public static protowire.TransactionOutput parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static protowire.TransactionOutput parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static protowire.TransactionOutput parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(protowire.TransactionOutput prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:protowire.TransactionOutput)
      protowire.TransactionOutputOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protowire.P2P.internal_static_protowire_TransactionOutput_descriptor;
    }
    ...
    // Construct using protowire.TransactionOutput.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public protowire.TransactionOutput getDefaultInstanceForType() {
      return protowire.TransactionOutput.getDefaultInstance();
    }

    @java.lang.Override
    public protowire.TransactionOutput build() {
      protowire.TransactionOutput result = buildPartial();
    ...
    @java.lang.Override
    public protowire.TransactionOutput buildPartial() {
      protowire.TransactionOutput result = new protowire.TransactionOutput(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof protowire.TransactionOutput) {
        return mergeFrom((protowire.TransactionOutput)other);
      } else {
    ...
    public Builder mergeFrom(protowire.TransactionOutput other) {
      if (other == protowire.TransactionOutput.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      protowire.TransactionOutput parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (protowire.TransactionOutput) e.getUnfinishedMessage();
    ...
    // @@protoc_insertion_point(builder_scope:protowire.TransactionOutput)
  }

  // @@protoc_insertion_point(class_scope:protowire.TransactionOutput)
  private static final protowire.TransactionOutput DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new protowire.TransactionOutput();
  }

  public static protowire.TransactionOutput getDefaultInstance() {
